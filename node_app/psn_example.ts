...
const npsso = "P1H9CitH4cfm6PIVBrzHY3jE30wAhElh8K29pSxfRc3m5sqDvz8Dsn7P5UyNR7dq";
...
async function main() {
  ...
  console.log("AUTH CODES RETRIEVED");
  ...
  const targetAccountId = "4997804777968500974";

  console.log("Target acc id: " + targetAccountId);

  // 3. Get the user's list of titles (games).
  const { trophyTitles } = await getUserTitles(authorization, targetAccountId);

  console.log("trophies recieved");
